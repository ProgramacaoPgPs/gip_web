...
const ModalDefault: React.FC<TaskItem> = (props) => {
  ...
  return (
    <div className='zIndex99'>
      <div className="card w-75 h-75 overflow-auto position-absolute modal-card-default">
        <section className='header-modal-default'>
          ...
          <ProgressBar progressValue={props.taskFilter.percent || 0} />
        </section>
        <section className='body-modal-default'>
          <BodyDefault taskListFiltered={props.taskFilter || []} listSubTasks={data || []}/>
        </section>
      </div>
    </div>
  );
