        ...
        <div id='moduleCLPP'>
            {
                ...
                <div className='bg-white p-2 rounded d-flex flex-column'>
                    <header>
                        <div>
                            <i className='fa-solid fa-comments'></i> Chat Log PegPese
                        </div>
                        <button onClick={()=>setIsConverse(false)} className='btn w-50'>Contatos</button>
                        <button onClick={()=>setIsConverse(true)} className='btn w-50'>Conversas</button>
                    </header>
                    <section className='d-flex justify-content-between bg-danger h-100 overflow-auto'>
                        {
                            isConverse
                                ?
                                <article>
